	...
	<view class="wrap">
		...
		<view class="list" v-if="list.length!=0">
			<view class="item" v-for="(item,index) in list">
				<view class="info_box">
					<u-image v-if="item.materialname=='动感单车'" :src="image" width="140rpx" height="140rpx" border-radius="8rpx"></u-image>
					<u-image v-else-if="item.materialname=='杠铃'" :src="image1" width="140rpx" height="140rpx" border-radius="8rpx"></u-image>
					<u-image v-else-if="item.materialname=='腹肌板'" :src="image2" width="140rpx" height="140rpx" border-radius="8rpx"></u-image>
					<u-image v-else-if="item.materialname=='跑步机'" :src="image3" width="140rpx" height="140rpx" border-radius="8rpx"></u-image>
					<view class="info-con">
