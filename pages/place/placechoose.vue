<template>
	<view class="wrap">
		<u-navbar title="场地选择" title-color="#FFFFFF" title-size="32" :border-bottom="false"
			:background="background" back-icon-size="40" back-icon-color="#ffffff" back-icon-name="arrow-left">
		</u-navbar>
		<!-- 教练列表 -->
		<view class="list">
			<view class="item" v-for="(item,index) in list">
				<u-image :src="item.image" width="210rpx" height="160rpx" border-radius="8rpx"></u-image>
				<view class="info-con">
